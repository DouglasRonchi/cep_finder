...
class TestEndpointCepFinder(unittest.TestCase):
    ...
    def test_success(self,
        ...
        cep_service_mock().find_cep.return_value = address_information
        ...
        self.assertEqual(response.neighborhood, 'São Paulo')
    ...
    def test_all_services_error(self,
        ...
        self.assertEqual(json.loads(response.body),
                         {'DateTime': '2021-10-03 09:18:20.618856',
                          'Error': 'CEP Inválido',
                          'Message': 'Não foi possível localizar o cep em nenhum dos serviços',
